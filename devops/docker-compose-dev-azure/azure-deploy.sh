...
resourcename="menuservice1"  # lower case, only
resourcegroup="menuservice1_rg"
...
# git clone https://github.com/apilogicserver/menuservice1.git
# cd menuservice1
...
az group create --name menuservice1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group menuservice1_rg --sku S1 --is-linux
az container create --resource-group menuservice1_rg --name menuservice1 --image apilogicserver/menuservice1:latest --dns-name-label menuservice1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//menuservice1.westus.azurecontainer.io:5656'
